...
<head>
    ...
    <meta name="description" content="Re 逆向">
    <title>Re 逆向</title>
    <!-- source_header -->
...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <article class="markdown"><?php echo file_get_contents('re.md'); ?></article>
