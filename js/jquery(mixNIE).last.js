...
var nie = nie || {}; !
        ...
        function(e) {
            var t = function(e, t) {
                ...
                o = function(e, i, r, c, o, s, l) {
                    return e = a(e, a(a(n(i, r, c), o), l)),
                        a(t(e, s), i)
                },
                s = function(e, n, r, c, o, s, l) {
                    return e = a(e, a(a(i(n, r, c), o), l)),
                        a(t(e, s), n)
                },
                l = function(e, n, i, c, o, s, l) {
                    return e = a(e, a(a(r(n, i, c), o), l)),
                        a(t(e, s), n)
                },
                u = function(e, n, i, r, o, s, l) {
                    return e = a(e, a(a(c(n, i, r), o), l)),
                        a(t(e, s), n)
                },
                m = function(e) {
                    for (var t, a = e.length,
                             n = a + 8,
                             i = (n - n % 64) / 64, r = 16 * (i + 1), c = Array(r - 1), o = 0, s = 0; a > s;) t = (s - s % 4) / 4,
                        o = s % 4 * 8,
            ...
            e.extend(e, {
                md5: function(e) {
                    var t, n, i, r, c, p, f, d, b, y = Array(),
                        ...
                        D = 15,
                        L = 21;
                    for (e = g(e), y = m(e), p = 1732584193, f = 4023233417, d = 2562383102, b = 271733878, t = 0; t < y.length; t += 16) n = p,
                        i = f,
                        r = d,
                        c = b,
            ...
            e.chainclude = function(t, a) {
                ...
                e.extend(e.include, {
                    ...
                    IEonload: function(e, t, a) {
                        e.onreadystatechange = function() { ("loaded" == this.readyState || "complete" == this.readyState) && t(a)
                        }
                    },
                    exist: function(t) {
                        var a = !1;
    ...
    !
        function($) {
            function unique(e) {
                for (var t, a = [], n = {},
                         i = 0; null != (t = e[i]); i++) n[t] || (a.push(t), n[t] = !0);
                return a
            }
            function filter(e, t) {
            ...
            nie.config = nie.config || {
                ...
                stats: {
                    ...
                    url: {
                        ...
                        _cb: function() {
                            for (var e = nie.config.stats.url._data,
                                     t = 0,
                                     a = e.length; a > t; t++) nie.config.stats.url._run(e[t].url, e[t].title, e[t].site)
                        },
                        _run: function(t, a, n) {
        ...
        function(e) {
            nie.util.stats = function() {
                ...
                if (null == nie.config.stats.id) {
                    if (null != nie.config.site) if ("undefined" != typeof t[nie.config.site]) a = n(nie.config.site);
                    else {
                ...
                null != a && e.include("//analytics.163.com/ntes.js",
                    function() {
...
var LocalData = {
        ...
        set: function(e, t) {
            ...
            } catch(a) {} else if (this.initDom()) try {
...
var ADBase = function(e) {
    ...
    function a(e) {
        for (var t = [], a = [], i = !!e[0].noCache, r = 0; r < e.length; r++) t.push(e[r].pos),
            a.push(e[r].callback);
        t = t.join(","),
            u({
                url: p.getData,
    ...
    function(e) {
        nie.util.topBar = nie.util.topBar ||
            function() { ! nie.config.topBar.hasRun && document.getElementById("NIE-topBar") && (nie.config.topBar.hasRun = !0, e.include(e.host + "/comm/nie.topBar/js/topBar.v2.last.js")),
            (document.getElementById("NIE-topBar") || document.getElementById("NIE-topBar-include")) && nie.util.addStyle(".adbase-ctn{background:url(" + e.host + "/comm/js/nie/util/img/loading.png) center center no-repeat;}")
            }
    } (jQuery),
    !
        function(e) {
                ...
                function() {
                    ...
                    if (t.length > 0 || a.length > 0) {
                        var n = e.host + "/comm/NIE_copyRight/images/",
                            ...
                            y = "\u79ef\u6781\u5065\u5eb7\u7684\u6e38\u620f\u5fc3\u6001\u662f\u5065\u5eb7\u6e38\u620f\u7684\u5f00\u7aef\uff0c\u672c\u6e38\u620f\u6545\u4e8b\u60c5\u8282\u8bbe\u7f6e\u7d27\u51d1\uff0c\u8bf7\u60a8\u5408\u7406\u63a7\u5236\u6e38\u620f\u65f6\u95f4\uff0c\u907f\u514d\u6c89\u6eba\u6e38\u620f\u5f71\u54cd\u751f\u6d3b\uff0c\u6ce8\u610f\u81ea\u6211\u4fdd\u62a4\uff0c\u9632\u8303\u7f51\u7edc\u9677\u9631\u3002<br />",
                            ...
                            j = function(e, t, a, n, i) {
                                var r = P ? "_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + a + "')": "background:url(" + a + ") no-repeat",
                                    c = n,
                                    o = "_blank";
                                return n || (c = "javascript:void(0);", o = "_self"),
                            ...
                            q = j(31, 31, n + "wen.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c4b4e62fe014b523d7ba00a15") + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c4b4e62fe014b523d7ba00a15"),
                        ...
                        switch (nie.config.copyRight.product) {
                            ...
                            case "zg":
                                S = 1,
                                    o = r + "[2010]W-SLG012\u53f7",
                                    m = j(39, 35, n + "leihuo.png") + j(27, 31, n + "ccnt.png", "http://182.131.21.137/ccnt-apply/publicservice/applyonline/product/gameBase!gameNetTag.action?oprBean.id=F35FC9BEF88A52AEE040007F01003007");
                                break;
                            case "sg":
                                o = r + "[2010]W-SLG013\u53f7",
                                    f = "\u672c\u6e38\u620f\u4e3a\u5168\u5730\u56fePK\u533a\u57df\u6e38\u620f";
                            ...
                            case "y3":
                                o = r + "(2013)C-CSG008\u53f7",
                                    s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7",
                                    h = "\u65b0\u5e7f\u51fa\u5ba1[2016]785\u53f7<br />ISBN 978-7-89988-708-0",
                                    m = A;
                                break;
                            case "zh":
                        ...
                        "gm" == nie.config.copyRight.product && /^\/user_help.html/.test(window.self.location.pathname) && (s = u, L = '\u5168\u56fd\u6587\u5316\u5e02\u573a\u7edf\u4e00\u4e3e\u62a5\u7535\u8bdd\uff1a12318\u3000\u6587\u5316\u90e8\u7f51\u7edc\u6e38\u620f\u4e3e\u62a5\u548c\u8054\u7cfb\u7535\u5b50\u90ae\u7bb1\uff1a<a href="mailto:wlwh@vip.sina.com">wlwh@vip.sina.com</a><br />', D = !0);
                        ...
                        if (D) {
                            ...
                            "mc" == nie.config.copyRight.product && (E = "Minecraft\u662fMicrosoft\u65d7\u4e0bMojang\u5f00\u53d1\u76843D\u6c99\u76d2\u6e38\u620f\uff0c\u7535\u8111\u7aef\u53ca\u624b\u673a\u7aef\u7248\u672c\u5728\u4e2d\u56fd\u5927\u9646\u7531\u7f51\u6613\u6e38\u620f\u8fd0\u8425<br>"),
                            "xy2" == nie.config.copyRight.product && (E = "<a href='http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44010602000260' target='_blank'><img src='" + n + "beian.png' />\u7ca4\u516c\u7f51\u5b89\u5907 44010602000260\u53f7</a><br>"),
                            "ff" == nie.config.copyRight.product && (E = "<a href='http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44010602000312' target='_blank'><img src='" + n + "beian.png' />\u7ca4\u516c\u7f51\u5b89\u5907 44010602000312\u53f7</a><br>"),
                                v = '<br><span id="ncp-l3" style="display:inline-block;padding-top:10px;">' + E + b.replace("$age", p) + y + L + (o ? '<a target="_blank" href="http://game.163.com/news/2010/6/9/442_216957.html">\u300a\u7f51\u7edc\u6e38\u620f\u7ba1\u7406\u6682\u884c\u529e\u6cd5\u300b</a>\u3000': "") + o + (s ? "\u300a\u7f51\u7edc\u6587\u5316\u7ecf\u8425\u8bb8\u53ef\u8bc1\u300b" + s: "") + (h ? " " + h: "") + " " + d + "</span>",
                                o = s = ""
                        } else k = "";
                        if (t.length > 0) { (I[nie.config.copyRight.product] || T == u) && (o = "", s = "", k = "");
                            var N = D ? "width:" + (y ? 832 : 765) + "px;text-align:left;": "width:100%;text-align:center;"; ("bw" == nie.config.copyRight.product || "qnm" == nie.config.copyRight.product) && (N = D ? "width:" + (y ? 900 : 765) + "px;text-align:left;": "width:100%;text-align:center;"),
                            "xqn" == nie.config.copyRight.product && (N = D ? "width:" + (y ? 900 : 765) + "px;text-align:left;": "width:100%;text-align:center;"),
                                i += '<p id="NIE-copyRight-corp" style="' + N + 'margin:0 auto;padding:15px 0 0 0;font-size:12px;font-family:\'\u5b8b\u4f53\';line-height:20px;display:block;position:relative;"><span style="position:relative;vertical-align:top;top:4px;display:inline-block;position:relative;">' + j(118, 31, n + "netease.{s}.png", "http://www.163.com", !0) + j(134, 31, n + "nie.{s}.png", "http://game.163.com") + m + '</span><span style="text-align:left;display:inline-block;padding-left:6px;"><span id="ncp-l1"><a href="http://gb.corp.163.com/gb/about/overview.html" target="_blank">\u516c\u53f8\u7b80\u4ecb</a> - <a href="http://help.163.com/" target="_blank">\u5ba2\u6237\u670d\u52a1</a> - <a href="http://gb.corp.163.com/gb/legal.html" target="_blank">\u76f8\u5173\u6cd5\u5f8b</a> - <a href="http://game.163.com/about/about.html" target="_blank">\u7f51\u6613\u6e38\u620f</a> - <a href="http://game.163.com/about/contactus.html" target="_blank">\u8054\u7cfb\u6211\u4eec</a> - <a href="http://game.163.com/bs/business.html" target="_blank">\u5546\u52a1\u5408\u4f5c</a> -' + (x ? w: "") + ' <a href="http://game.163.com/job/" target="_blank">\u52a0\u5165\u6211\u4eec</a>' + (_ ? R: "") + '</span><br /><span id="ncp-l2">' + z + " &copy;1997-2016\u3000" + o + "\u3000" + s + "  " + k + "</span></span>",
                            (I[nie.config.copyRight.product] || T == u) && (D ? "xqn" == nie.config.copyRight.product && (B = B.replace("right:70px;", "right:50px;")) : B = B.replace("position:absolute;right:70px;top:38px;", "position:relative;left:-173px;top:2px;"), i += B, i = i.replace("line-height:20px;", "line-height:24px;")),
                                i += "tx3" == nie.config.copyRight.product ? v + "<br><span>tx3.163.com\u7531\u5e7f\u5dde\u7f51\u6613\u8ba1\u7b97\u673a\u7cfb\u7edf\u6709\u9650\u516c\u53f8\u6388\u6743\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u4f7f\u7528</span></p>": v + "</p>",
        ...
        function(e) {
            nie.util.union = nie.util.union || {
                ...
                processUrl: function() {
                    ...
                    if (e.inArray(this.url.raw, this.unionFabUrlList) >= 0) this.url.isUnion = !0,
                ...
                setupUnion: function(t) {
                    ...
                    function n(e, t) { (new Image).src = e + "&urs=" + t
                    }
    ...
    !
        function(e) {
            function t() {
                ...
                return i && 1 > i && i > 0 ? (t = i, n.dpr = i) : isNaN(screen.deviceXDPI) || isNaN(screen.logicalXDPI) ? a.outerWidth > 0 && a.innerWidth > 0 && (n.outerWidth = a.outerWidth, n.innerWidth = a.innerWidth, t = a.outerWidth / a.innerWidth) : t = screen.deviceXDPI / screen.logicalXDPI,
                    n.zoom = t,
                1 !== e(t, 1)
            }
            function a() {
